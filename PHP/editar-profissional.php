...
$diasSelecionados =
    explode(',', $profissional['dias_semana']);
...
<form action="salvar-edicao-profissional.php" method="POST">
    ...
    <div class="row mb-3">
        ...
        <div class="col-6">
            ...
            <input
                ...
                name="hora_inicio"
                class="form-control"
                value="<?= $profissional['hora_inicio'] ?>"
                required
            >
